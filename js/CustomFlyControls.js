/**
 * modefied for custom usage ( just added a callback for keyboard event)
 * original @author James Baicoianu / http://www.baicoianu.com/
 */

THREE.CustomFlyControls = function ( object, keydownCallback, domElement , initialQuaternion) {
	...
	this.rotate = function(x,y,z) {
		this.tmpQuaternion.set(x,y,z,1).normalize;
